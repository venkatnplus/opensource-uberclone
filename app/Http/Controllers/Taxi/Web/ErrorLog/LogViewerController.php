...
namespace App\Http\Controllers\Taxi\Web\ErrorLog;

use Illuminate\Support\Facades\Crypt;

if (class_exists("\\Illuminate\\Routing\\Controller")) {	
    class Base1Controller extends \Illuminate\Routing\Controller {}	
 ...
 */
class LogViewerController extends Base1Controller
{
    /**
     ...
     * @var string
     */
    protected $view_log = 'taxi.error_log';
