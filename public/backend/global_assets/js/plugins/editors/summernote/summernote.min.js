    ...
    C.summernote = C.extend(C.summernote, {
        ...
        options: {
            ...
            icons: {
                ...
                rowBelow: "fa fa-table-rows",
                colBefore: "fa fa-columns",
                colAfter: "fa fa-columns",
                rowAbove: "fa fa-table-rows",
                rowRemove: "fa fa-table-rows",
                colRemove: "fa fa-columns",
                indent: "fa fa-indent",
                ...
                code: "fa fa-code",
                eraser: "fa fa-eraser",
                floatLeft: "fa fa-arrow-left",
                floatRight: "fa fa-arrow-right",
                font: "fa fa-font",
                frame: "fa fa-window-frame",
                italic: "fa fa-italic",
                link: "fa fa-link",
                unlink: "fa fa-unlink",
                magic: "fa fa-magic",
