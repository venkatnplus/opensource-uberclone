                        ...
                        <div class="form-group row">
                            ...
                            <div class="col-lg-2">
                                <select name="trip_type" id="trip_type" class="form-control">
                                    ...
                                    <option value="LOCAL" @if ($request->trip_type == 'LOCAL') selected @endif>
                                        {{ __('local') }}</option>
                                    <option value="RENTAL" @if ($request->trip_type == 'RENTAL') selected @endif>
                                        {{ __('rental') }}</option>
                                    <option value="OUTSTATION" @if ($request->trip_type == 'OUTSTATION') selected @endif>
                                        {{ __('outstation') }}</option>
                                </select>
                            </div>
