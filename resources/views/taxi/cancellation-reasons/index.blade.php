...
<div class="content">
        ...
        <div class="card-header header-elements-inline">
            ...
            <div class="header-elements">
                <div class="list-icons">
                    @if(auth()->user()->can('new-cancelreason'))
    ...
    <div class="card" id="tableDiv">
        ...
        <table class="table datatable-button-print-columns1" id="roletable">
            ...
            <tbody>
                @foreach($cancellationReasons as $key => $cancellations)
                    <tr>
                        <td>{{ ++$key }}</td>
                        ...
                        <td>    
                            ...
                            <div class="dropdown-menu dropdown-menu-right " x-placement="top-end" style="position: absolute; will-change: transform; top: 0px; left: 0px; transform: translate3d(-164px, -178px, 0px);">
                                @if(auth()->user()->can('edit-cancelreason'))
                                ...
                                @endif
                                @if(auth()->user()->can('delete-cancelreason'))
                                ...
                                @endif
                                @if(auth()->user()->can('active-cancelreason'))
