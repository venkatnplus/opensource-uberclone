    ...
    <div class="card-form animated bounceInDown col-md-4" id="card_local_trip">
        <div class="card-header bg-white header-elements-inline" style="justify-content: center;">
            ...
            <ul class="card-title nav nav-pills">
                ...
                <li class="nav-item"><a href="#solid-tab3" onclick="changeType('outstation')" class="nav-link rounded-round legitRipple @if($request_detail->trip_type == "OUTSTATION") active @else disabled @endif" data-toggle="tab">Outstation</a></li>
            </ul>
