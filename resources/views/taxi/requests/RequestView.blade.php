                        ...
                        <div class="card-body">
                            <ul class="list-group">
                                ...
                                @if($outstation_trip) <li class="list-group-item font-weight-semibold">{{ __('trip_end') }}<span class="ml-auto">{{$outstation_trip ? $outstation_trip->trip_end_km : '0.00'}} Km</span></li>@endif
                                    ...
                                    <li class="list-group-item text-danger">{{ __('admin_commission')}}<span class="ml-auto">{{$request->requested_currency_symbol}} {{$request->requestBill ? $request->requestBill->admin_commision : '0.00'}}</span></li>
