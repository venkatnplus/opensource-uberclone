        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header header-elements-inline">
                    <h6 class="card-title">{{ __('trip_wise_reports') }}</h6>
                        ...
                        <table class="table datatable-button-print-columns1 table-bordered" id="roletable">
                            <thead>
                                <tr>
                                    ...
                                    <th colspan="2" scope="colgroup">{{ __('local') }}</th> <!-- merge four columns -->
                                    <th colspan="2" scope="colgroup">{{ __('rental') }}</th>
                                    <!-- <th colspan="2" scope="colgroup">{{ __('outstation') }}</th> -->
                                </tr>
                                <tr>
                            ...
                            <tbody>
                                 @foreach($trips as $value)
                                    <tr>
                                        <td>{{$value->date}}</td>
                                        <td>{{$value->local_completed}}</td>
                                        <td>{{$value->local_cancelled}}</td>
                                        <td>{{$value->rental_completed}}</td>
                                        <td>{{$value->rental_cancelled}}</td>
                                        <!-- <td>{{$value->outstation_completed}}</td>
                                        <td>{{$value->outstation_cancelled}}</td> -->
                                    </tr>
                                @endforeach
                            </tbody>
                        </table>
